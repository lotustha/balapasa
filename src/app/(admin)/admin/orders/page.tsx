          ...
          <div className="relative">
            ...
            {printMenu && (
              <div className="absolute top-full right-0 mt-1 z-30 bg-white border border-slate-200 rounded-xl shadow-xl overflow-hidden w-52">
                ...
                {[
                  { type:'shipping',     label:'Shipping Label',  sub:'A6 · barcode + COD + tracking'    },
                  { type:'invoice-a4',   label:'Invoice A4',      sub:'210×297mm · full-page'            },
                  ...
                  { type:'all',          label:'All Documents',   sub:'Invoice A4 + Label + Slip'        },
                ].map(d => (
