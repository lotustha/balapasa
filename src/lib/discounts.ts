// Auto-discount rules — pure, prisma-free so both server routes and client
// components (cart, checkout) can share one source of truth and never drift.
// The DB-backed loader (getRules) lives in api/discount-rules/route.ts.
